...
/* package haskellmaze-0.1.0.0 */
#ifndef VERSION_haskellmaze
#define VERSION_haskellmaze "0.1.0.0"
#endif /* VERSION_haskellmaze */
#ifndef MIN_VERSION_haskellmaze
#define MIN_VERSION_haskellmaze(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellmaze */
...
#define CURRENT_COMPONENT_ID "haskellmaze-0.1.0.0-inplace-haskellmaze"
